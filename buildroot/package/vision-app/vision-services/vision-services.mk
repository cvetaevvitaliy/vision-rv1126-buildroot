...
VISION_SERVICES_VERSION =  production_mode
...
ifeq ($(BR2_PACKAGE_VISION_MANUFACTURING_SERVICE),y)
	VISION_SERVICES_CONF_OPTS += "-DBUILD_TEST_SERVICE=ON"
else
	VISION_SERVICES_CONF_OPTS += "-DBUILD_TEST_SERVICE=OFF"
endif
...
ifeq ($(BR2_PACKAGE_VISION_MANUFACTURING_SERVICE),n)
